...
export const projectEntries: WorkEntry[] = [
  ...
  },
  {
    ...
    linkText: "Balloon",
    technologies: ["ISO 27001", "Security", "Compliance", "Implementation"],
  },
  {
    id: "chefkoch-plus-subscription",
    title: {
      de: "Chefkoch PLUS",
      en: "Chefkoch PLUS",
    },
    summary: {
      de: "Food-Plattform / Abo",
    ...
    linkText: "chefkoch.de",
    year: 2022,
    technologies: ["VueJS", "PHP", "On-Premise", "Amazon Web Services"],
  },
  {
    id: "hirschhausen-diaet",
    title: {
      de: "Hirschhausen Diät",
      en: "Hirschhausen Diet",
    },
    summary: {
      de: "Intervalfasten / Mobile App",
  ...
  },
  {
    ...
    summary: {
      de: "Hochzeitsportal / Headless CMS",
  ...
  },
  {
    ...
    linkText: "Hausgold",
    year: 2014,
    technologies: ["Ruby On Rails", "Amazon Web Services"],
  },
  {
    id: "pay-with-a-tweet",
    title: {
    ...
    summary: {
      de: "Social Commerce / Social Payment",
  ...
  },
  {
    ...
    linkText: "REBELLE",
    year: 2013,
    technologies: ["Ruby On Rails", "Objective-C", "Amazon Web Services"],
  },
  {
    id: "stern-emagazine",
    title: {
    ...
    summary: {
      de: "News-Magazin / iPad-Ausgabe",
      en: "News magazine / iPad edition",
    },
    description: {
    ...
    linkText: "stern eMagazine",
    year: 2010,
    technologies: ["Adobe Flex/Woodwing", "AppStore"],
  },
];